...
// BerryStudio-Upgrade-Plan-v3.2 WP-42 Stage B — wraps the STANDALONE build
// only (main.jsx). NOT used by embed.js: the embedded engine has no
...
export default function EntitlementGate({ children }) {
  const [state, setState] = useState({ loading: true, signedIn: false, entitlement: null })
  ...
  if (isAllowed(state.entitlement)) return children
